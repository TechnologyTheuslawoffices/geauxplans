        ...
        <div className="container">
          <div className="ep-hero-grid">
            <div className="ep-hero-content">
              ...
              <h1>Minor <em className="text-blue">Child-Centered</em><br /><strong>Estate Plan</strong></h1>
              <p className="ep-hero-description">
                <em>Create a Will-Based estate plan to appoint a Tutor to act as a surrogate parent for your children if something should ever happen to you. Specify your final wishes for possessions and arrangements, as well as decide who will control your affairs if you become incapacitated.</em>
              </p>
            ...
            <div className="ep-hero-image">
              <img src="/wp-content/uploads/2022/02/Minor-Child-Centered-Estate-Plan-banner.jpg" alt="Minor Child-Centered Estate Plan" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="ep-build-grid">
            <div className="ep-build-card">
              <h2><strong><em>Build your</em></strong><br /><span className="text-blue"><em><strong>Minor Child-Centered Estate Plan</strong></em></span></h2>
              ...
              <div className="documents-accordion">
                <div className={`doc-item ${expandedDoc === 'will' ? 'expanded' : ''}`}>
                  <button onClick={() => toggleDoc('will')}>
                    <span>Last Will and Testament <em>(with Nomination of Tutors)</em></span>
                    <span className="toggle-icon">{expandedDoc === 'will' ? '−' : '+'}</span>
                  </button>
                  <div className="doc-content">
                    <p>The centerpiece of your estate plan dictates your final wishes for minor children, possessions, and arrangements.</p>
                  </div>
                </div>
          ...
          <div className="benefits-grid">
            <div className="benefits-content">
              ...
              <ul className="benefits-list">
                ...
                <li><i className="fas fa-check"></i> Establish protective trusts for minor children</li>
            ...
            <div className="benefits-images">
              <img src="/wp-content/uploads/2022/02/Minor-Child-Centered-Estate-Plan-1.jpg" alt="" />
              <img src="/wp-content/uploads/2022/02/Minor-Child-Centered-Estate-Plan-2.jpg" alt="" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="modal-overlay" onClick={() => setShowPurchaseModal(false)}>
          <div className="modal-content purchase-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-center mb-4">
              ...
              />
              <h2 style={{ color: '#0000ff' }}>Minor Child-Centered Estate Plan</h2>
              ...
              <p className="mb-4">Average time to build a plan: <strong style={{ color: '#0000ff' }}>15 minutes</strong></p>
            </div>
...
export default MinorChildEstatePlan;
