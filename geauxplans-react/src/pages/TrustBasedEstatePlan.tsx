        ...
        <div className="container">
          <div className="ep-hero-grid">
            ...
            <div className="ep-hero-image">
              <img src="/wp-content/uploads/2022/02/Trust-Based-Estate-Plan-1024x684.jpg" alt="Trust-Based Estate Plan" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="ep-build-grid">
            ...
            <div className="ep-documents">
              ...
              <div className="documents-accordion">
                <div className={`doc-item ${expandedDoc === 'trust' ? 'expanded' : ''}`}>
                  <button onClick={() => toggleDoc('trust')}>
                ...
                <div className={`doc-item ${expandedDoc === 'extract' ? 'expanded' : ''}`}>
                  <button onClick={() => toggleDoc('extract')}>
                    <span>Extract of Trust</span>
                    <span className="toggle-icon">{expandedDoc === 'extract' ? '−' : '+'}</span>
                  </button>
                  <div className="doc-content">
                    <p>Contains limited information about the Trust that must be filed in the public records when a Trust owns real estate.</p>
                  </div>
                </div>
                <div className={`doc-item ${expandedDoc === 'certificate' ? 'expanded' : ''}`}>
                  <button onClick={() => toggleDoc('certificate')}>
                    <span>Certificate of Trust</span>
                    <span className="toggle-icon">{expandedDoc === 'certificate' ? '−' : '+'}</span>
                  </button>
                  <div className="doc-content">
                    <p>Contains a summary of key provisions of the Trust to be given to third parties in lieu of the full Trust Agreement in the interest of privacy. No personal details are disclosed.</p>
                  </div>
                </div>
                <div className={`doc-item ${expandedDoc === 'funding' ? 'expanded' : ''}`}>
                  <button onClick={() => toggleDoc('funding')}>
                    <span>Trust Funding Guide</span>
                    <span className="toggle-icon">{expandedDoc === 'funding' ? '−' : '+'}</span>
                  </button>
                  <div className="doc-content">
                    <p>A set of instructions to place assets into Trust to help ensure you avoid probate.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="benefits-grid">
            <div className="benefits-content">
              ...
              <ul className="benefits-list">
                <li><i className="fas fa-check"></i> Establish a Revocable Trust to avoid probate (a/k/a succession)</li>
            ...
            <div className="benefits-images">
              <img src="/wp-content/uploads/2022/02/Trust-Based-Estate-Plan-1.jpg" alt="" />
              <img src="/wp-content/uploads/2022/02/Trust-Based-Estate-Plan-2.jpg" alt="" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="faq-contact-grid">
            ...
            <div className="faq-content">
              ...
              <div className="faq-accordion">
                ...
                <div className={`faq-item ${expandedFaq === 'why-trust' ? 'expanded' : ''}`}>
                  <button onClick={() => toggleFaq('why-trust')}>
                    <span>Why choose a Trust-Based Estate Plan?</span>
                    <span className="toggle-icon">{expandedFaq === 'why-trust' ? '−' : '+'}</span>
                  </button>
                  <div className="faq-answer">
                    <p><strong>Avoid Probate:</strong> A trust allows your assets to pass directly to your beneficiaries without the time and expense of court proceedings.</p>
                    <p><strong>Privacy:</strong> Unlike a will, which becomes public record, a trust remains private.</p>
                    <p><strong>Control:</strong> You can specify exactly how and when your assets are distributed to your beneficiaries.</p>
                  </div>
                </div>
...
export default TrustBasedEstatePlan;
